...
lanyard.onopen = () => {
    ...
    lanyard.send(
        JSON.stringify({
            op: OPCODES.INIT,
            d: {
                subscribe_to_id: "737196145431937036",
            },
        })
    );
};
...
lanyard.onmessage = ({ data }) => {
    ...
    if (parsedData.op === OPCODES.HELLO) {
        ...
        if (parsedData.t === "INIT_STATE") {
            ...
            elements.avatar.src = `https://cdn.discordapp.com/avatars/737196145431937036/${user.discord_user.avatar}?size=128`;
            ...
            try {
                ...
                if (a === 3) {
                    ...
                    elements.durum.innerText =
                        "Discord Status: " + user.activities[0].state + "\n What am I doing: " + user.activities[1].name;
                }
